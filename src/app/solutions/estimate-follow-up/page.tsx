      ...
      <div className="relative z-10">
        ...
        <main className="pt-24 md:pt-32">
            ...
            <div className="max-w-[1400px] mx-auto px-6">
              <div className="max-w-4xl">
                <div className="flex items-center gap-3 mb-8">
                  <span className="w-2 h-2 rounded-full bg-brand-red shadow-[0_0_10px_rgba(158,27,31,0.5)]"></span>
                  <span className="text-[10px] md:text-xs font-semibold tracking-[0.2em] text-brand-red uppercase">
                    Core Service
                  </span>
                </div>
                ...
                <h1 className="text-5xl md:text-6xl lg:text-8xl font-semibold mb-10 tracking-tighter leading-[1.05]">
                  ...
                  <span className="text-brand-red">Go Cold</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6">
                  <Link
                    ...
                    className="relative inline-flex h-16 w-full sm:w-auto overflow-hidden rounded-full p-[1px] focus:outline-none group shadow-[0_0_40px_-5px_rgba(158,27,31,0.2)] transition-all hover:scale-[1.02] active:scale-95 duration-300"
                  >
                    <span className="absolute inset-0 bg-gradient-to-r from-brand-red/40 via-brand-red/80 to-brand-red/40 opacity-70 group-hover:opacity-100 transition-opacity duration-500" />
                    <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-brand-red px-10 text-base font-semibold text-white backdrop-blur-3xl gap-3 transition-colors group-hover:bg-brand-red/90 whitespace-nowrap">
              ...
              <div className="grid lg:grid-cols-3 gap-8 items-start">
                <div className="lg:col-span-2 grid sm:grid-cols-2 gap-6">
                  {problemCards.map((card, index) => (
                    ...
                    >
                      <div className="w-12 h-12 rounded-xl bg-black/[0.03] flex items-center justify-center text-brand-red mb-6">
                ...
                <div className="lg:col-span-1 h-full">
                  <SpotlightCard
                    spotlightColor="rgba(158, 27, 31, 0.08)"
                    className="p-10 bg-surface border border-brand-red/20 rounded-3xl h-full flex flex-col justify-center relative overflow-hidden"
                  >
                    <div className="absolute top-0 right-0 p-8 opacity-5">
                      <Settings className="w-40 h-40 text-brand-red" />
                    </div>
                    ...
                    <p className="text-text-secondary font-light leading-relaxed mb-6 relative z-10">
                      The goal is <span className="text-brand-navy font-medium">not</span> to over-automate everything.
                    </p>
          ...
          <section className="py-20 lg:py-32 bg-background border-y border-black/5 relative overflow-hidden">
             <div className="absolute inset-0 bg-brand-red/2 blur-[120px] pointer-events-none" />
             <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                <div className="mb-16">
                  <h2 className="text-3xl md:text-5xl font-semibold text-brand-navy mb-6 tracking-tight">Practical follow-up fixes.</h2>
                  <p className="text-xl text-brand-red font-medium">Not bloated software talk.</p>
                </div>
             ...
             <div className="max-w-[1400px] mx-auto px-6">
                <div className="bg-surface border border-black/10 rounded-[3rem] p-10 md:p-20 relative overflow-hidden shadow-2xl shadow-black/[0.04]">
                   ...
                   <h2 className="text-3xl md:text-5xl font-semibold text-brand-navy mb-16 tracking-tight relative z-10 max-w-3xl">
                     A cleaner path from estimate to <span className="text-brand-red">booked work.</span>
                   </h2>
                   ...
                   <div className="grid md:grid-cols-2 gap-x-12 gap-y-10 relative z-10">
                      <div className="flex gap-5">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">Fewer leads lost</p>
                           <p className="text-text-secondary font-light leading-relaxed">Closing the gap after the estimate is sent so warm leads don't fade out.</p>
                         </div>
                      </div>
                      ...
                      <div className="flex gap-5">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">A more consistent process</p>
                           <p className="text-text-secondary font-light leading-relaxed">Having a repeatable system for follow-up that runs reliably every single time.</p>
                         </div>
                      </div>
                      ...
                      <div className="flex gap-5">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">Less dependence on memory</p>
                           <p className="text-text-secondary font-light leading-relaxed">Moving away from scattered sticky notes and relying on a solid process instead.</p>
                         </div>
                      </div>
                      ...
                      <div className="flex gap-5">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">Clearer next steps</p>
                           <p className="text-text-secondary font-light leading-relaxed">Guiding prospects who are trying to decide what to do next without being pushy.</p>
                         </div>
                      </div>
                      ...
                      <div className="flex gap-5 md:col-span-2 md:justify-center md:max-w-xl md:mx-auto mt-4">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">A better booking path</p>
                           <p className="text-text-secondary font-light leading-relaxed">Supporting more closed jobs and scheduled work from the demand already coming in.</p>
                         </div>
                      </div>
                   </div>
                </div>
          ...
          <section className="py-24 md:py-32 relative overflow-hidden border-t border-black/5 text-center">
            ...
            <div className="max-w-3xl mx-auto px-6 relative z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-brand-red/20 bg-brand-red/5 text-brand-red text-[10px] uppercase font-bold tracking-widest mb-8">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-brand-navy mb-8 tracking-tighter leading-tight">
                ...
                <span className="text-brand-red">what happens after the estimate.</span>
              </h2>
              ...
              <div className="flex flex-col items-center justify-center gap-6">
                <a
                  ...
                  className="relative inline-flex h-16 md:h-20 overflow-hidden rounded-full p-[1px] focus:outline-none group shadow-[0_0_50px_-10px_rgba(158,27,31,0.2)] w-full sm:w-auto transition-all hover:scale-[1.02] active:scale-95 duration-300"
                >
                  <span className="absolute inset-0 bg-gradient-to-r from-brand-red/50 via-brand-red to-brand-red/50 opacity-100 group-hover:opacity-80 transition-opacity duration-500" />
                  <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-brand-red px-10 md:px-14 text-base md:text-lg font-semibold text-white backdrop-blur-3xl gap-4 transition-colors group-hover:bg-brand-red/90 whitespace-nowrap">
                    Review My Current Setup
          ...
          <section className="py-20 mb-20 bg-background border-y border-black/5">
             <div className="max-w-[1000px] mx-auto px-6">
                ...
                <div className="space-y-6">
                   <SpotlightCard spotlightColor="rgba(158, 27, 31, 0.05)" className="p-8 md:p-10 bg-surface border border-black/10 shadow-2xl shadow-black/[0.02] rounded-[2rem]">
                      <h3 className="text-xl font-semibold text-brand-navy mb-4">Is this the same as a CRM setup?</h3>
                   ...
                   <SpotlightCard spotlightColor="rgba(158, 27, 31, 0.05)" className="p-8 md:p-10 bg-surface border border-black/10 shadow-2xl shadow-black/[0.02] rounded-[2rem]">
                      <h3 className="text-xl font-semibold text-brand-navy mb-4">Do I need automation for this to work?</h3>
                      <p className="text-lg text-text-secondary font-light leading-relaxed">
