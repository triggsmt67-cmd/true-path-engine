...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.truepath406.com/solutions/lead-velocity/'
  }
};
...
export default function LeadResponsePage() {
  const serviceSchema = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://www.truepath406.com/solutions/lead-velocity/#webpage",
        "url": "https://www.truepath406.com/solutions/lead-velocity/",
        "name": "Missed Call Recovery & Lead Response | True Path Digital",
        "description": "Set up a cleaner, faster lead-response process so calls, forms, and quote requests stop slipping through the cracks.",
        "isPartOf": { "@id": "https://www.truepath406.com/#website" },
        "breadcrumb": { "@id": "https://www.truepath406.com/solutions/lead-velocity/#breadcrumb" },
        "mainEntity": { "@id": "https://www.truepath406.com/solutions/lead-velocity/#service" }
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.truepath406.com/solutions/lead-velocity/#breadcrumb",
        "itemListElement": [
      ...
      {
        "@type": "Service",
        "@id": "https://www.truepath406.com/solutions/lead-velocity/#service",
    ...
    <div className="min-h-screen bg-background text-text-primary font-sans selection:bg-brand-accent selection:text-brand-navy relative">
      ...
      <div className="relative z-10">
        ...
        <main className="pt-24 md:pt-32">
            ...
            <div className="max-w-[1400px] mx-auto px-6">
              <div className="max-w-4xl">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-8xl font-semibold mb-10 tracking-tighter leading-[1.05]">
                  ...
                  <span className="text-brand-accent">Missed Calls and Slow Response</span>
                </h1>
          ...
          <section className="py-20 lg:py-32 bg-background border-y border-black/5 relative overflow-hidden">
             ...
             <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                <div className="mb-16">
                  ...
                  <p className="text-xl text-brand-accent font-medium">Not abstract sales process talk.</p>
                </div>
             ...
             <div className="max-w-[1400px] mx-auto px-6">
                <div className="bg-surface border border-black/10 rounded-[3rem] p-10 md:p-20 relative overflow-hidden shadow-2xl shadow-black/[0.04]">
                   ...
                   <h2 className="text-3xl md:text-5xl font-semibold text-brand-navy mb-16 tracking-tight relative z-10 max-w-3xl">
                     A cleaner response path that helps more leads <span className="text-brand-accent">turn into real jobs.</span>
                   </h2>
          ...
          <section className="py-24 md:py-32 relative overflow-hidden border-t border-black/5 text-center">
            ...
            <div className="max-w-3xl mx-auto px-6 relative z-10">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-brand-navy mb-8 tracking-tighter leading-tight">
                ...
                <span className="text-brand-accent">how leads are handled now.</span>
              </h2>
          ...
          <RelatedInsights categoryName="lead-velocity" />
