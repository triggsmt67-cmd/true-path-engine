        ...
        <main className="pt-24 md:pt-32">
            ...
            <div className="max-w-[1400px] mx-auto px-6">
              <div className="max-w-4xl">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-8xl font-semibold mb-10 tracking-tighter leading-[1.05]">
                  ...
                  <span className="text-brand-red">Missed Calls and Slow Response</span>
                </h1>
              ...
              <div className="grid lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="lg:col-span-1 h-full">
                  ...
                  >
                    ...
                    <p className="text-text-secondary font-light leading-relaxed mb-6 relative z-10">
                      The goal is <span className="text-brand-navy font-medium">not</span> to add more noise.
                    </p>
          ...
          <section className="py-20 lg:py-32 bg-background border-y border-black/5 relative overflow-hidden">
             ...
             <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                <div className="mb-16">
                  <h2 className="text-3xl md:text-5xl font-semibold text-brand-navy mb-6 tracking-tight">Practical response improvements.</h2>
                  <p className="text-xl text-brand-red font-medium">Not abstract sales process talk.</p>
                </div>
             ...
             <div className="max-w-[1400px] mx-auto px-6">
                <div className="bg-surface border border-black/10 rounded-[3rem] p-10 md:p-20 relative overflow-hidden shadow-2xl shadow-black/[0.04]">
                   ...
                   <h2 className="text-3xl md:text-5xl font-semibold text-brand-navy mb-16 tracking-tight relative z-10 max-w-3xl">
                     A cleaner response path that helps more leads <span className="text-brand-red">turn into real jobs.</span>
                   </h2>
                   ...
                   <div className="grid md:grid-cols-2 gap-x-12 gap-y-10 relative z-10">
                      <div className="flex gap-5">
                         ...
                         <div>
                           ...
                           <p className="text-text-secondary font-light leading-relaxed">Plugging the leaks so demand stops falling off after the very first contact.</p>
                         </div>
                      </div>
                      ...
                      <div className="flex gap-5">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">Clearer intake process</p>
                           <p className="text-text-secondary font-light leading-relaxed">A more unified way of handling calls, forms, texts, and inbound quote requests.</p>
                         </div>
                      </div>
                      ...
                      <div className="flex gap-5">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">Faster response</p>
                           <p className="text-text-secondary font-light leading-relaxed">Setting up simple processes that buy you time while capturing the lead instantly.</p>
                         </div>
                      </div>
                      ...
                      <div className="flex gap-5">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">Consistent follow-up</p>
                           <p className="text-text-secondary font-light leading-relaxed">Less dependence on memory and more consistency in closing warm opportunities.</p>
                         </div>
                      </div>
                   </div>
                </div>
          ...
          <section className="py-24 md:py-32 relative overflow-hidden border-t border-black/5 text-center">
            ...
            <div className="max-w-3xl mx-auto px-6 relative z-10">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-brand-navy mb-8 tracking-tighter leading-tight">
                ...
                <span className="text-brand-red">how leads are handled now.</span>
              </h2>
             ...
             <div className="max-w-[1000px] mx-auto px-6">
                ...
                <div className="space-y-6">
                   <SpotlightCard spotlightColor="rgba(158, 27, 31, 0.05)" className="p-8 md:p-10 bg-surface border border-black/10 shadow-2xl shadow-black/[0.02] rounded-[2rem]">
                      <h3 className="text-xl font-semibold text-brand-navy mb-4">Is this the same as CRM setup or automation?</h3>
                   ...
                   <SpotlightCard spotlightColor="rgba(158, 27, 31, 0.05)" className="p-8 md:p-10 bg-surface border border-black/10 shadow-2xl shadow-black/[0.02] rounded-[2rem]">
                      <h3 className="text-xl font-semibold text-brand-navy mb-4">Do I need more leads first?</h3>
                      <p className="text-lg text-text-secondary font-light leading-relaxed">
