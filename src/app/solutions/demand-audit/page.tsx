...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.truepath406.com/solutions/demand-audit/'
  }
};
...
export default function DemandAuditPage() {
  const serviceSchema = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://www.truepath406.com/solutions/demand-audit/#webpage",
        "url": "https://www.truepath406.com/solutions/demand-audit/",
        "name": "Demand Leak Audit | True Path Digital",
        "description": "Find out where visibility, follow-up, trust, or conversion is breaking down before you spend more trying to fix the wrong thing.",
        "isPartOf": { "@id": "https://www.truepath406.com/#website" },
        "breadcrumb": { "@id": "https://www.truepath406.com/solutions/demand-audit/#breadcrumb" },
        "mainEntity": { "@id": "https://www.truepath406.com/solutions/demand-audit/#service" }
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.truepath406.com/solutions/demand-audit/#breadcrumb",
        "itemListElement": [
      ...
      {
        "@type": "Service",
        "@id": "https://www.truepath406.com/solutions/demand-audit/#service",
            ...
            <div className="max-w-[1400px] mx-auto px-6">
              <div className="max-w-4xl">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-8xl font-semibold mb-10 tracking-tighter leading-[1.05]">
                  ...
                  <span className="text-brand-accent">Slipping Through the Cracks</span>
                </h1>
             ...
             <div className="max-w-[1400px] mx-auto px-6">
                <div className="bg-surface border border-black/10 rounded-[3rem] p-10 md:p-20 relative overflow-hidden shadow-2xl shadow-black/[0.04]">
                   ...
                   <h2 className="text-3xl md:text-5xl font-semibold text-brand-navy mb-16 tracking-tight relative z-10 max-w-3xl">
                     A clearer next move and <span className="text-brand-accent">fewer expensive guesses.</span>
                   </h2>
          ...
          <section className="py-24 md:py-32 relative overflow-hidden border-t border-black/5 text-center">
            ...
            <div className="max-w-3xl mx-auto px-6 relative z-10">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-brand-navy mb-8 tracking-tighter leading-tight">
                ...
                <span className="text-brand-accent">what is happening right now.</span>
              </h2>
