        ...
        <main className="pt-24 md:pt-32">
            ...
            <div className="max-w-[1400px] mx-auto px-6">
              <div className="max-w-4xl">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-8xl font-semibold mb-10 tracking-tighter leading-[1.05]">
                  ...
                  <span className="text-brand-red">Slipping Through the Cracks</span>
                </h1>
              ...
              <div className="grid lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="lg:col-span-1 h-full">
                  ...
                  >
                    ...
                    <p className="text-text-secondary font-light leading-relaxed mb-6 relative z-10">
                      The goal is <span className="text-brand-navy font-medium">not</span> to hand you a giant strategy deck.
                    </p>
          ...
          <section className="py-20 lg:py-32 bg-background border-y border-black/5 relative overflow-hidden">
             ...
             <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                <div className="mb-16">
                  <h2 className="text-3xl md:text-5xl font-semibold text-brand-navy mb-6 tracking-tight">A practical review of the places demand usually leaks out.</h2>
                </div>
             ...
             <div className="max-w-[1400px] mx-auto px-6">
                <div className="bg-surface border border-black/10 rounded-[3rem] p-10 md:p-20 relative overflow-hidden shadow-2xl shadow-black/[0.04]">
                   ...
                   <h2 className="text-3xl md:text-5xl font-semibold text-brand-navy mb-16 tracking-tight relative z-10 max-w-3xl">
                     A clearer next move and <span className="text-brand-red">fewer expensive guesses.</span>
                   </h2>
                   ...
                   <div className="grid md:grid-cols-2 gap-x-12 gap-y-10 relative z-10">
                      <div className="flex gap-5">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">A clearer picture</p>
                           <p className="text-text-secondary font-light leading-relaxed">Understanding exactly where work is actually being lost in the flow of the business.</p>
                         </div>
                      </div>
                      ...
                      <div className="flex gap-5">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">Better understanding</p>
                           <p className="text-text-secondary font-light leading-relaxed">Knowing whether the issue is visibility, trust, response speed, or conversion.</p>
                         </div>
                      </div>
                      ...
                      <div className="flex gap-5">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">A practical list</p>
                           <p className="text-text-secondary font-light leading-relaxed">A straight-forward prioritization of exactly what to fix first, with no fluff.</p>
                         </div>
                      </div>
                      
                      <div className="flex gap-5">
                         <div className="w-12 h-12 rounded-full bg-brand-red/10 flex items-center justify-center flex-shrink-0">
                           <PiggyBank className="w-5 h-5 text-brand-red" />
                         </div>
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">Less wasted money</p>
                           <p className="text-text-secondary font-light leading-relaxed">Avoiding unnecessary ad spend, tool sprawl, or website rebuilds by fixing the right things.</p>
                         </div>
                      </div>
                      ...
                      <div className="flex gap-5 md:col-span-2 md:justify-center md:max-w-xl md:mx-auto mt-4">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">A confident next step</p>
                           <p className="text-text-secondary font-light leading-relaxed">Moving forward with a plan based on what is really happening, not what agency frameworks suggest.</p>
                         </div>
                      </div>
                   </div>
                </div>
          ...
          <section className="py-24 md:py-32 relative overflow-hidden border-t border-black/5 text-center">
            ...
            <div className="max-w-3xl mx-auto px-6 relative z-10">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-brand-navy mb-8 tracking-tighter leading-tight">
                ...
                <span className="text-brand-red">what is happening right now.</span>
              </h2>
