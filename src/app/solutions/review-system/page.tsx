        ...
        <main className="pt-24 md:pt-32">
            ...
            <div className="max-w-[1400px] mx-auto px-6">
              <div className="max-w-4xl">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-8xl font-semibold mb-10 tracking-tighter leading-[1.05]">
                  ...
                  <span className="text-brand-red">Chasing Customers</span>
                </h1>
              ...
              <div className="grid lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="lg:col-span-1 h-full">
                  ...
                  >
                    ...
                    <p className="text-text-secondary font-light leading-relaxed mb-6 relative z-10">
                      The goal is <span className="text-brand-navy font-medium">not</span> to game reviews.
                    </p>
          ...
          <section className="py-20 lg:py-32 bg-background border-y border-black/5 relative overflow-hidden">
             ...
             <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                <div className="mb-16">
                  <h2 className="text-3xl md:text-5xl font-semibold text-brand-navy mb-6 tracking-tight">A cleaner review process.</h2>
                  <p className="text-xl text-brand-red font-medium">Not vague reputation talk.</p>
                </div>
             ...
             <div className="max-w-[1400px] mx-auto px-6">
                <div className="bg-surface border border-black/10 rounded-[3rem] p-10 md:p-20 relative overflow-hidden shadow-2xl shadow-black/[0.04]">
                   ...
                   <h2 className="text-3xl md:text-5xl font-semibold text-brand-navy mb-16 tracking-tight relative z-10 max-w-3xl">
                     More visible proof. Less guesswork in <span className="text-brand-red">how you earn it.</span>
                   </h2>
                   ...
                   <div className="grid md:grid-cols-2 gap-x-12 gap-y-10 relative z-10">
                      <div className="flex gap-5">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">A more consistent flow</p>
                           <p className="text-text-secondary font-light leading-relaxed">A steady, predictable stream of real customer reviews replacing random bursts of feedback.</p>
                         </div>
                      </div>
                      ...
                      <div className="flex gap-5">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">Stronger visible trust</p>
                           <p className="text-text-secondary font-light leading-relaxed">Proof that stands out when local prospects are comparing you directly against competitors.</p>
                         </div>
                      </div>
                      
                      <div className="flex gap-5">
                         <div className="w-12 h-12 rounded-full bg-brand-red/10 flex items-center justify-center flex-shrink-0">
                           <Fingerprint className="w-5 h-5 text-brand-red" />
                         </div>
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">Easier request process</p>
                           <p className="text-text-secondary font-light leading-relaxed">Less dependence on memory and more consistency in asking exactly when the customer is happiest.</p>
                         </div>
                      </div>
                      ...
                      <div className="flex gap-5">
                         ...
                         <div>
                           <p className="text-lg text-brand-navy font-medium mb-2">Better online alignment</p>
                           <p className="text-text-secondary font-light leading-relaxed">Ensuring the quality of the work you do is actually reflected in the way the business appears online.</p>
                         </div>
                      </div>
                   </div>
                </div>
          ...
          <section className="py-24 md:py-32 relative overflow-hidden border-t border-black/5 text-center">
            ...
            <div className="max-w-3xl mx-auto px-6 relative z-10">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-brand-navy mb-8 tracking-tighter leading-tight">
                ...
                <span className="text-brand-red">your current review process.</span>
              </h2>
             ...
             <div className="max-w-[1000px] mx-auto px-6">
                ...
                <div className="space-y-6">
                   <SpotlightCard spotlightColor="rgba(158, 27, 31, 0.05)" className="p-8 md:p-10 bg-surface border border-black/10 shadow-2xl shadow-black/[0.02] rounded-[2rem]">
                      <h3 className="text-xl font-semibold text-brand-navy mb-4">Is this about buying reviews or using gimmicks?</h3>
                   ...
                   <SpotlightCard spotlightColor="rgba(158, 27, 31, 0.05)" className="p-8 md:p-10 bg-surface border border-black/10 shadow-2xl shadow-black/[0.02] rounded-[2rem]">
                      <h3 className="text-xl font-semibold text-brand-navy mb-4">Do reviews really matter that much?</h3>
                      <p className="text-lg text-text-secondary font-light leading-relaxed">
